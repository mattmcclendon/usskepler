...
title: "USS Kepler"
pubTitle: "Vessel Profile"
author: "Starfleet Corps of Records"
department: "Command"
stardate: "80524.885"
federationDate: "2403-Jul-11"
excerpt: "Mission history, command structure, deployment record, and the role of USS Kepler within the Frontier Initiative."
---
...
The ship serves as a mobile platform for the Frontier Initiative, supporting Federation member worlds, colonies, settlements, and emerging communities throughout the frontier. Additional details regarding the program can be found in the [Frontier Initiative](#frontier-initiative) section below.
...
Additional personnel records are available through the [Crew Manifest](/crew).
...
<div style="text-align: center; margin-top: 2rem; margin-bottom: 1rem; background: none; border: none; box-shadow: none; padding: 0;">
  <img
    src="/images/shared/kepler-formation.webp"
    alt="USS Kepler formation flight"
    style="display: block; width: 100%; max-width: 1000px; height: auto; margin: 0 auto; background: transparent; border: 0; box-shadow: none; padding: 0;"
  />
</div>
<br /><br />
